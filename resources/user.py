...
class bookResource(Resource):
    ...
    def post(self):
        ...
        log1=query(f"""select * from bookingHistory where user_id='{data["id"]}' and date_format(day,"%Y-%m-%d")=date_format(curdate(),"%Y-%m-%d")and status = CAST(1 AS UNSIGNED);""",return_json=False)
